...
<sql:query dataSource = "${snapshot}" var = "details">
       SELECT * FROM DETAILS  where email='<%= request.getParameter("email") %>';
         </sql:query>
				  ...
				  <img src="resources/images/${details.img}" alt=""/>
                    ...
                    <div class="col-md-6">
                        <div class="profile-head"> 
                                    ...
                                    <p class="proile-rating"> ${details.degree} / ${details.dept}</p>
                    ...
                    <div class="col-md-2">
                        <a href="resources/images/${details.filename}" download class="pull-right"><img title="Download Resume"style="width:150px;height:200px;" class="img-square img-responsive" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDPvoBsucbRLlHHRXniKfevt8JYDDSNgjn_PdsLeRZ2JslQGDvlA"></a>
                    </div>
                </div>                                          
                <div class="row">
                    <div class="col-md-4">
